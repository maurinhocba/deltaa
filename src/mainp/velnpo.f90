 SUBROUTINE velnpo (ndofn, npoin, nvelr, ifpre, nesdf, npsdf,      &
 ...
 INTEGER (kind=4), INTENT(IN) :: ndofn, npoin, nvelr, ifpre(:,:),  &
                                 nesdf(:),npsdf(:)
