 MODULE ele02_db
   ...
   USE mat_dba, ONLY: section,sect_search,mater,psecs,pmats,inte_cr,nusect
   USE c_input, ONLY : openfi,listen,exists,param,lures,getint,getrea,rdreqs,backs
   IMPLICIT NONE
   ...
   TYPE ele02
     ...
     ! for each standard element  (1) l0   : original length
                                 ...
                                 !(8) Lb   : Increment in plastic strain
                                 !(9) Ep   : plastic strain (LastConverged)
                                 !(10)BS   : back stress (LC)
                                 !(11)Eps  : Effective plastic strain(LC)
