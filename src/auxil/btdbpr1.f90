 SUBROUTINE btdbpr1(b,d,e,ncol,nrow,size)
 !**********************************************************************
 !                             T
 ...
 !             E  = SIZE * SIZE     ONLY THE UPPER TRIANGLE IS CONSTRUCTED
 !             A  = NROW            AUXILIAR VECTOR
 !
 !**********************************************************************
 IMPLICIT NONE
 INTEGER (kind=4),INTENT(IN) :: nrow, ncol, size
 ...
 DO i=1,ncol                                           !row i of e
   ...
   END DO                                              ! J=1,NCOL
   i_j = i_j + (size-ncol)                           ! update position in E

 END DO                                                ! I=1,NCOL
 RETURN

 END SUBROUTINE btdbpr1
