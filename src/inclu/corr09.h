      SUBROUTINE corr09(st11,st22,st12,efpst,c,prop,ierr,dstpl,lc)
      !-------------------------------------------------------------------
      !
      !     Anisotropy Behaviour (Oller & Car)
      !
      !-------------------------------------------------------------------
      USE lispa0
      IMPLICIT NONE
      ...
      REAL (kind=8),INTENT(IN) :: lc         !equivalent lenght (fracture)
